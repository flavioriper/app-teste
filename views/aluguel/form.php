                ...
                <div class="row">
                    <div class="col">
                        <div class="page-description page-description-tabbed">
                            ...
                            <h1 id="get-step-title">Adicionar Aluguel Único</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                                <form id="step-form" form="imoveis">
                                    ...
                                    $exclude = [
                                        ...
                                        'field' => [
                                            ...
                                            'casa_verde_e_amarela',  
                                            'aceita_permuta', 
                                            'descricao_das_permutas'
                                        ],
                                        'taxonomy' => [
                                            'oferta'=> [ 
                                                'lancamento',
                                            ...
                                            do {
                                                ...
                                                if( $unserialize['type'] == 'taxonomy' ) {
                                                    ...
                                                    foreach($terms as $term) {
                                                        if(isset($exclude['taxonomy'][$unserialize['taxonomy']])) {
                                                            foreach($exclude['taxonomy'][$unserialize['taxonomy']] as $remove) {
                                                                if(!in_array($term->slug, $exclude['taxonomy'][$unserialize['taxonomy']])) {
                                                            ...
                                                            if($unserialize['taxonomy'] == 'faixa_preco') {
                                                                ...
                                                                //Somente adiciona caso possua "Aluguel" na array
