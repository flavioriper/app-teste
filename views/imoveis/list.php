...
acf_form_head(); ?>
    ...
    <div class="app-content" route="imoveis">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end mx-5">
                        <?php if ($vista_status === '0'): ?>
                            <a id="sincronizar-vista" url-link="<?=get_site_url().'/app/api/vista/sync-imoveis'?>" class="btn btn-secondary" type="button">
                                Sincronizar Vista
                            </a>
                        <?php elseif ($vista_status === '1' ): ?>
                            <div class="btn btn-secondary">
                                <span class="mx-1">Sincronizando Vista</span>
                                <div class="spinner-border spinner-border-sm" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                            </div>
                        <?php endif ?>
                        <a onclick="location.href = '<?= (!$publish_verify) ? get_site_url() . '/anuncie-seu-imovel' : base::url('imoveis/adicionar') ?>';" id="add-unidade" class="btn btn-secondary" type="button">
                                                ...
                                                <div class="row list align-items-center"> 
                                                    ...
                                                    <div class="col-1 d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="form-check form-switch ms-3">
                                                            <input data-action="status"  data-target="imoveis" data-id="<?= $imovel->ID ?>" class="form-check-input" type="checkbox" <?= ($imovel->post_status == 'publish') ? 'checked' : '' ?>>
                                                        </div>
                                                    </div>
                                                    <div class="col-3 d-flex align-items-center justify-content-center justify-content-lg-end"> 

                                                        <button data-action="edit" data-target="imoveis" data-id="<?= $imovel->ID ?>" type="button" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center me-0 me-lg-2">
                                                            <span class="material-icons-two-tone icon-white">edit</span> Editar
                                                        </button>
                                                        <button data-action="delete" data-target="imoveis" data-id="<?= $imovel->ID ?>" type="button" class="btn btn-danger btn-sm d-flex align-items-center justify-content-center">
